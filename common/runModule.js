...
if(window.myBrowserType =="IE"){
    var resize = function(){
        if($(window).width()<768){
            var styleDom = $('<style name="scube_ui">.myForm label{width:100%;}</style>');
            $(document).find('style[name=scube_ui]').remove();
            $(document).find('head').append(styleDom);
        }else if($(window).width()>=768 && $(window).width()<1200){
            var styleDom = $('<style name="scube_ui">.myForm label{width:50%;}</style>');
            $(document).find('style[name=scube_ui]').remove();
            $(document).find('head').append(styleDom);
        }else if($(window).width()>=1200){
            var styleDom = $('<style name="scube_ui">.myForm label{width:33.33333%;}</style>');
            $(document).find('style[name=scube_ui]').remove();
            $(document).find('head').append(styleDom);
        }
    }
